...
from back.ml.artist.features import ARTIST_GENRE_FEATURE_FORMAT, ARTIST_GENRE_TOKEN_PATTERN
...
def train_artist_knn_from_db(
    ...
    from back.ml.artist.data import fetch_artist_knn_training_data

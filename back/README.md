...
- Load KNN models (artist + release group) from local paths
...
Offline scripts for training machine learning models.
...
Directory for `.pkl` model files generated by training scripts.
...
From the repository root, build and run locally:

"""Load the release group KNN artifact at startup (local file)."""

import joblib

from app.models.loader import (
    build_load_info,
    ensure_legacy_back_package_aliases,
    resolve_artifact_path,
)
from app.release_group.config import APP_ROOT, release_group_local_path_raw
...
def load_release_group_model():
    """Load release group artifact from RELEASE_GROUP_MODEL_LOCAL_PATH."""
